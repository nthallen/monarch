...
#endif
{
  ...
  case 19: _nst[_nsp]=Mkrule_029(&curpos, _nst[_nsp+0]); break;
  ...
  case 38: _nsp -= 1;_nst[_nsp]=Mkrule_028(&curpos, _nst[_nsp+0], _nst[_nsp+1]); break;
  ...
  case 48: _incrnodestack();_nst[_nsp]=Mkrule_032(&curpos); break;
  ...
  case 57: _nst[_nsp]=Mkrule_034(&curpos, _nst[_nsp+0]); break;
  case 58: _nst[_nsp]=Mkrule_031(&curpos, _nst[_nsp+0]); break;
  case 59: _nst[_nsp]=Mkrule_030(&curpos, _nst[_nsp+0]); break;
  ...
  case 66: _nst[_nsp]=Mkrule_033(&curpos, _nst[_nsp+0]); break;
