...
readescape(const char *start, int m)
#else
 ...
 *   On exit-
 *     readescape=number of characters in the escape
 ***/
...
/* CONTROL */
    case 'a': CharValue = '\007'; return 1;
    case 'n': CharValue = '\n'; return 1;
    case 't': CharValue = '\t'; return 1;
    case 'r': CharValue = '\r'; return 1;
    case 'f': CharValue = '\f'; return 1;
    case 'b': CharValue = '\b'; return 1;
    case 'v': CharValue = '\v'; return 1;
...
void 
#if defined(__cplusplus) || defined(__STDC__)
c_mkstr(const char *c, int length, int *t, int *v)
#else
...
void
#if defined(__cplusplus) || defined(__STDC__)
c_mkchar(const char *c, int l, int *t, int *v)
#else
c_mkchar(c, l, t, v)
char *c;
int l, *t;
