...
DefTableKey OutFile = NoKey;
static int OutFile_count = 0;
DefTableKey CmdFile = NoKey;
static int CmdFile_count = 0;
DefTableKey MFile = NoKey;
static int MFile_count = 0;
DefTableKey DispFile = NoKey;
static int DispFile_count = 0;
DefTableKey VerbFile = NoKey;
static int VerbFile_count = 0;
...
static opt opts[] = {
    ...
    { "-o", STRVAL | SPACED, &OutFile_count, &OutFile, NULL },
    { "-c", STRVAL | SPACED, &CmdFile_count, &CmdFile, NULL },
    { "-m", STRVAL | SPACED, &MFile_count, &MFile, NULL },
    { "-d", STRVAL | SPACED, &DispFile_count, &DispFile, NULL },
    { "-v", STRVAL | SPACED, &VerbFile_count, &VerbFile, NULL },
    { "--", TERM, NULL, NULL, NULL },
...
#endif
{
  ...
  fprintf (stderr, "    -o string Write compiled QCLI code to specified file\n");
  fprintf (stderr, "    -c string Write cmd code to specified file\n");
  fprintf (stderr, "    -m string Write Matlab waveform data to specified file\n");
  fprintf (stderr, "    -d string Write display definitions to specified file\n");
  fprintf (stderr, "    -v string Write verbose summary to specified file\n");
